...
// ---------- DEMO STAGE ----------
function DemoStage({ state, prompt, result, progress }) {
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
          <button data-el-name="ボタン" type="button" style={{
            background: 'var(--accent)',
            color: '#0a0a0a',
            border: 'none',
            borderRadius: 8,
          ...
          <button data-el-name="サブボタン" type="button" style={{
    ...
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }} data-screen-label="01 Home">
      ...
      <main className="main-wrap" style={{ flex: 1 }}>
        <div className="demo-stage-wrap">
          <DemoStage state={state} prompt={activePrompt} result={result} progress={progress} />
        </div>
